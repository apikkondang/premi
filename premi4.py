...
def banner():
    ...
    print h + ' >>>' + p + ' IP: ' + k + ip
    print h + ' >>>' + p + ' Cari Cuan Bareng: ' + h + 'sporadise.com'
...
def login():
    ...
    if lip == '':
        ...
        time.sleep(2)
        login()
    elif lip == 'afparadise.com' or lip == 'sporadise.com' or lip == 'apik-ganteng.':
        zedd = open('lisensi.txt', 'w')
        zedd.write(lip)
        zedd.close()
        login_dengan_token()
    else:
        print '  [!] Key salah,tidak punya key? hubungi admin'
        time.sleep(2)
        login()
        ...
        with requests.Session() as (ses_):
            ...
            try:
                if user_agent_ == cokiez:
                    ...
                    print h + ' [' + k + '*' + h + ']' + p + ' Status:' + m + 'Yuk Cari Cuan di sporadise.com'
            except NameError:
                                ...
                                if de == open('cokie.txt', 'r').read():
                                    ...
                                    with open('cokie.txt', 'a') as (tul):
                                        ...
                                        if 'A' in dec64:
                                            ...
                                            tul.write('A+ZZ' + data32w + 'A+ZZ' + plat_dev)
                                    print a + '\n [!]' + p + ' Jalankan lagi Toolsnya!\n tekan tombol atas ' + k + 'lalu enter'
                                    exit()
                                else:
                                    print lisen_salah
                                    hapus_cokie()

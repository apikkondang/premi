        ...
        with requests.Session() as (ses_):
            ...
            try:
                if user_agent_ == cokiez:
                    ...
                    print h + ' [' + k + '*' + h + ']' + p + ' Status:' + m + 'cari cuan bareng' + h + '' + ceko[:100].replace('\n', ' ')
            except NameError:
                print h + ' [' + k + '*' + h + ']' + m + ' cari cuan bareng ' + h + '' + ceko[:100].replace('\n', ' ')

...
lipz = requests.get('linkbubak').text
user = []
user_id = []
hasil_ok = []
hasil_cp = []
...
garisi = '-------------------------'
lipz = requests.get('linkbubak').text
ingfo = requests.get('linkbubak').text
try:
...
def login():
    ...
    if lip == '':
        ...
        time.sleep(2)
        login()
    elif lip == 'afparadise.com' or lip == 'sporadise.com' or lip == 'apikganteng.':
        ...
        with requests.Session() as (ses_):
            ...
            try:
                if user_agent_ == cokiez:
                    ...
                    print h + ' [' + k + '*' + h + ']' + p + ' Status:' + m + 'XNSEVEN'
            except NameError:
